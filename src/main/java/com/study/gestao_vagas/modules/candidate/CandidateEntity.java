package com.study.gestao_vagas.modules.candidate;
...
public class CandidateEntity {
    ...
    @Schema(example = "Daniel Sousa", requiredMode = RequiredMode.REQUIRED, description = "Nome do candidato")
    private String name;
    ...
    @Schema(example = "admin@1234", minLength = 10, maxLength = 100, requiredMode = RequiredMode.REQUIRED, description = "Senha do utilizador")
